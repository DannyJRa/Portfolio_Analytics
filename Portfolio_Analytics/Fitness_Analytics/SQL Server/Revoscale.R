...
#SOURCE: https://www.blue-granite.com/tutorials/sql-server-r-services
###
...
sql.conn.string <- 'driver={SQL Server};server=CHZRH4044768B;database=WideWorldImportersDW;trusted_connection=true'
