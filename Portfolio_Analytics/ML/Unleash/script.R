...
p = ggplot(data = pima.melt, aes(x = type, y = value)) + geom_boxplot() + facet_wrap(~variable, ncol = 2)
p
...
#feature selection with caret package/ rfeControl()
set.seed(123)
